...
Namespace Services
    ...
    Public Class MockDataService
        ...
        ''' <summary>
        ''' Inizializza i dati mock - 5 ordini di esempio
        ''' </summary>
        Private Sub InitializeMockData()
            ...
            Dim order1 As New Order() With {
                ...
                .Courier = "DHL",
                .Revenue = New Revenue() With {.ProductValue = 250D, .ShippingValue = 15D, .Discounts = 0D, .Total = 265D},
                .Costs = New Costs() With {.ProductCost = 180D, .ShippingCost = 12D, .Commissions = 26.5D, .Total = 218.5D},
                .Margin = New Margin() With {.Value = 46.5D, .Percentage = 17.55D},
                .HasValidProductCosts = True,
                .HasValidShippingCosts = True
            }
            order1.Shipments.Add(New Shipment() With {
                .Id = "ORD-001-1", .OrderId = "ORD-001", .TrackingNumber = "TRK001234567",
                .Marketplace = "Amazon", .CustomerName = "Mario Rossi", .Quantity = 1,
                ...
                .HasValidProductCost = True, .HasValidShippingCost = True
            })
            order1.Shipments.Add(New Shipment() With {
                .Id = "ORD-001-2", .OrderId = "ORD-001", .TrackingNumber = "TRK001234568",
                .Marketplace = "Amazon", .CustomerName = "Mario Rossi", .Quantity = 1,
            ...
            ' Ordine 2: eBay - IN PERDITA
            Dim order2 As New Order() With {
                .Id = "ORD-002", .Marketplace = "eBay", .CustomerName = "Giulia Bianchi",
                .OrderDate = New DateTime(2025, 1, 16, 9, 15, 0), .FulfillmentDate = New DateTime(2025, 1, 17, 11, 30, 0),
                .Supplier = "Fornitore B", .Warehouse = "Magazzino B", .Courier = "UPS",
                ...
                .HasValidProductCosts = False, .HasValidShippingCosts = False
            }
            order2.Shipments.Add(New Shipment() With {
                .Id = "ORD-002-1", .OrderId = "ORD-002", .TrackingNumber = "TRK002345678",
                .Marketplace = "eBay", .CustomerName = "Giulia Bianchi", .Quantity = 1,
                .Revenue = New Revenue() With {.ProductValue = 89.9D, .ShippingValue = 9.9D, .Discounts = 5D, .Total = 94.8D},
                .Costs = New Costs() With {.ProductCost = 95D, .ShippingCost = 12D, .Commissions = 9.48D, .Total = 116.48D},
                .Margin = New Margin() With {.Value = -21.68D, .Percentage = -22.87D},
                .HasValidProductCost = False, .HasValidShippingCost = False
            })
            _mockOrders.Add(order2)

            ' Ordine 3: Sito Web - MARGINE ZERO
            Dim order3 As New Order() With {
                .Id = "ORD-003", .Marketplace = "Sito Web", .CustomerName = "Luca Verdi",
                .OrderDate = New DateTime(2025, 1, 17, 14, 45, 0), .FulfillmentDate = Nothing,
                .Supplier = "Fornitore C", .Warehouse = "Magazzino A", .Courier = "GLS",
                ...
                .HasValidProductCosts = True, .HasValidShippingCosts = True
            }
            order3.Shipments.Add(New Shipment() With {
                .Id = "ORD-003-1", .OrderId = "ORD-003", .TrackingNumber = "TRK003456789",
                .Marketplace = "Sito Web", .CustomerName = "Luca Verdi", .Quantity = 1,
                .Revenue = New Revenue() With {.ProductValue = 150D, .ShippingValue = 12D, .Discounts = 0D, .Total = 162D},
                .Costs = New Costs() With {.ProductCost = 150D, .ShippingCost = 12D, .Commissions = 0D, .Total = 162D},
                .Margin = New Margin() With {.Value = 0D, .Percentage = 0D},
                .HasValidProductCost = True, .HasValidShippingCost = True
            ...
            Dim order4 As New Order() With {
                .Id = "ORD-004", .Marketplace = "Amazon", .CustomerName = "Anna Neri",
                .OrderDate = New DateTime(2025, 1, 18, 11, 20, 0), .FulfillmentDate = New DateTime(2025, 1, 19, 15, 10, 0),
                .Supplier = "Fornitore A", .Warehouse = "Magazzino B", .Courier = "BRT",
            ...
            order4.Shipments.AddRange({
                New Shipment() With {.Id = "ORD-004-1", .OrderId = "ORD-004", .TrackingNumber = "TRK004567890",
                    .Marketplace = "Amazon", .CustomerName = "Anna Neri", .Quantity = 1,
                    ...
                    .HasValidProductCost = True, .HasValidShippingCost = True},
                New Shipment() With {.Id = "ORD-004-2", .OrderId = "ORD-004", .TrackingNumber = "TRK004567891",
                    .Marketplace = "Amazon", .CustomerName = "Anna Neri", .Quantity = 1,
                    ...
                    .HasValidProductCost = True, .HasValidShippingCost = True},
                New Shipment() With {.Id = "ORD-004-3", .OrderId = "ORD-004", .TrackingNumber = "TRK004567892",
                    .Marketplace = "Amazon", .CustomerName = "Anna Neri", .Quantity = 1,
            ...
            ' Ordine 5: eBay - IN PERDITA
            Dim order5 As New Order() With {
                .Id = "ORD-005", .Marketplace = "eBay", .CustomerName = "Paolo Gialli",
                .OrderDate = New DateTime(2025, 1, 19, 16, 30, 0), .FulfillmentDate = New DateTime(2025, 1, 20, 10, 0, 0),
                .Supplier = "Fornitore B", .Warehouse = "Magazzino A", .Courier = "SDA",
                ...
                .HasValidProductCosts = True, .HasValidShippingCosts = False
            }
            order5.Shipments.AddRange({
                New Shipment() With {.Id = "ORD-005-1", .OrderId = "ORD-005", .TrackingNumber = "TRK005678901",
                    .Marketplace = "eBay", .CustomerName = "Paolo Gialli", .Quantity = 1,
                    ...
                    .HasValidProductCost = True, .HasValidShippingCost = False},
                New Shipment() With {.Id = "ORD-005-2", .OrderId = "ORD-005", .TrackingNumber = "TRK005678902",
                    .Marketplace = "eBay", .CustomerName = "Paolo Gialli", .Quantity = 1,
                    .Revenue = New Revenue() With {.ProductValue = 99.95D, .ShippingValue = 7.45D, .Discounts = 10D, .Total = 97.4D},
        ...
        ''' <summary>
        ''' Ottiene liste per ComboBox filtri
        ''' </summary>
        Public Function GetSuppliers() As List(Of String)
            Return _mockOrders.Select(Function(o) o.Supplier).Distinct().Where(Function(s) Not String.IsNullOrEmpty(s)).ToList()
        End Function

        Public Function GetWarehouses() As List(Of String)
            Return _mockOrders.Select(Function(o) o.Warehouse).Distinct().Where(Function(w) Not String.IsNullOrEmpty(w)).ToList()
        End Function

        Public Function GetCouriers() As List(Of String)
            Return _mockOrders.Select(Function(o) o.Courier).Distinct().Where(Function(c) Not String.IsNullOrEmpty(c)).ToList()
        End Function

        Public Function GetMarketplaces() As List(Of String)
            Return _mockOrders.Select(Function(o) o.Marketplace).Distinct().ToList()
        End Function
    End Class
End Namespace
